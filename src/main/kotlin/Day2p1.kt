fun main() {
    fun part1(input: List<String>): Int {
        ...
        var totalScore = 0
        for (i in input) {
            val col1 = i[0].toString()
            val col2 = i[2].toString()

            when {
                col1Map[col1] == col2Map[col2] -> {
                    totalScore += pointsMap["draw"]!! + pointsMap[col2]!!
                }
                winningMap[col1Map[col1]!!] == col2Map[col2] -> {
                    totalScore += pointsMap["win"]!! + pointsMap[col2]!!
                }
                else -> {
                    totalScore += pointsMap[col2]!!
                }
            }
        }
